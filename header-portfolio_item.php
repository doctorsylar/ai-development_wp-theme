...
<header id="header" class="homepage-header">
    <div class="header-container col-12 col-sm-12 col-md-11 col-lg-10">
        <div class="header-logo">
            <a href="<?= get_home_url() ?>" class="anchor">
                <img src="<?= temp_dir ?>/img/svg/logo.svg" alt="ai-development">
            </a>
        </div>
        <nav class="header-menu horizontal-menu">
            <ul>
                <li class="link-services"><a class="" href="<?= get_home_url() ?>#services"><i class="fa fa-files-o"></i>Услуги</a></li>
                <li class="link-portfolio"><a class="" href="<?= get_home_url() ?>#portfolio"><i class="fa fa-book"></i>Портфолио</a></li>
                <li class="link-skills"><a class="" href="<?= get_home_url() ?>#skills"><i class="fa fa-star"></i>Навыки</a></li>
                <li class="link-about"><a class="" href="<?= get_home_url() ?>#about"><i class="fa fa-street-view"></i>Обо мне</a></li>
                <li class="link-contact"><a class="" href="<?= get_home_url() ?>#contact"><i class="fa fa-envelope-open"></i>Контакты</a></li>
            </ul>
        </nav>
